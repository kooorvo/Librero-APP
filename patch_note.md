...
## 📅 **Journal de Développement**
 ...
 --- 
 ## 📌 Prochaines Étapes
 - [ ] Ajout d'un switch pour passer du mode clair au mode sombre
 - [ ] Ajouter la base de donnée regroupant les différents emprunteurs
 - [ ] Rendre le programme executable
 - [ ] Création d'un site web
 - [ ] Ajouter la possibilitée de copier les résultats